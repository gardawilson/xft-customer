...
class _AuthResponse extends AuthResponse {
  const _AuthResponse({required this.success, required this.message, required this.data}): super._();
...
mixin _$AuthData {
 ...
 String get token;@JsonKey(name: 'customer') UserModel get user;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthData&&(identical(other.token, token) || other.token == token)&&(identical(other.user, user) || other.user == user));
}
...
@useResult
$Res call({
 String token,@JsonKey(name: 'customer') UserModel user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token, @JsonKey(name: 'customer')  UserModel user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String token, @JsonKey(name: 'customer')  UserModel user)  $default,) {final _that = this;
switch (_that) {
case _AuthData():
return $default(_that.token,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token, @JsonKey(name: 'customer')  UserModel user)?  $default,) {final _that = this;
switch (_that) {
case _AuthData() when $default != null:
return $default(_that.token,_that.user);case _:
  return null;
...
class _AuthData extends AuthData {
  const _AuthData({required this.token, @JsonKey(name: 'customer') required this.user}): super._();
  factory _AuthData.fromJson(Map<String, dynamic> json) => _$AuthDataFromJson(json);

@override final  String token;
@override@JsonKey(name: 'customer') final  UserModel user;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthData&&(identical(other.token, token) || other.token == token)&&(identical(other.user, user) || other.user == user));
}
